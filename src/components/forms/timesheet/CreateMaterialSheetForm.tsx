...
import { createMaterialBalanceSheetInput } from "@/types/timesheet";
...
interface CreateMaterialSheetFormProps {
  onClose: () => void;
  onSubmit: (data: createMaterialBalanceSheetInput) => void;
}

const CreateMaterialSheetForm: React.FC<CreateMaterialSheetFormProps> = ({
  onClose,
  onSubmit,
}) => {
  ...
  const balance = calculateBalance(receivedQty, utilizedQty);
...
export default CreateMaterialSheetForm;
